...
EntityPlayer = ig.Entity.extend({
	...
	size: {x:16, y:24},
	offset: {x:4, y:4},
	animSheet: new ig.AnimationSheet('media/player.png', 24, 32),
	zIndex: 80, // put below UI (100)
	...
	update: function() {
		...
		if (this.touches(cursor)) {
			if (!this.first_touch) {
				...
				this.animSheet = new ig.AnimationSheet('media/player-highlight.png', 24, 32);
				this.addAnim('idle', 1, [0] );	// 1 fps, play frame 1
				this.addAnim('up', 0.2, [3, 4, 3, 5]);
				this.addAnim('down',0.2,[0, 1, 0, 2]);
				this.addAnim('left', 0.2, [6, 7, 6, 8]);
			...
			if (this.first_touch) {
				...
				this.animSheet = new ig.AnimationSheet('media/player.png', 24, 32);
				this.addAnim('idle', 1, [0] );	// 1 fps, play frame 1
				this.addAnim('up', 0.2, [3, 4, 3, 5]);
				this.addAnim('down',0.2,[0, 1, 0, 2]);
				this.addAnim('left', 0.2, [6, 7, 6, 8]);
