...
EntityPlayer = ig.Entity.extend({
	...
	init: function( x, y, settings ) {
		...
		this.addAnim('idleup', 0.2, [8, 9, 10, 11]);
		this.addAnim('idledown',0.2,[0, 1, 2, 3]);
		this.addAnim('idleleft', 0.2, [16, 17, 18, 19]);
		this.addAnim('idleright', 0.2, [24, 25, 26, 27]);

		this.addAnim('up', 0.2, [12, 13, 14, 15]);
		this.addAnim('down',0.2,[4, 5, 6, 7]);
		this.addAnim('left', 0.2, [20, 21, 22, 23]);
