...
EntityCursor = ig.Entity.extend({
    ...
    check: function(other) {
    	...
    	if (other.name == "player") {
    		...
    		other.animSheet = new ig.AnimationSheet('media/player-highlight.png', 16, 16);
    		other.addAnim('idle', 1, [0] );	// 1 fps, play frame 1
			other.addAnim('up', 0.2, [3, 4, 3, 5]);
			other.addAnim('down',0.2,[0, 1, 0, 2]);
			other.addAnim('left', 0.2, [6, 7, 6, 8]);
			other.addAnim('right', 0.2, [9, 10, 9, 11]);
